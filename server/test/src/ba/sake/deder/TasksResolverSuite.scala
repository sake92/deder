...
class TasksResolverSuite extends munit.FunSuite {
  ...
  private def baseScalaModuleTaskEdges(moduleId: String): Set[(String, String)] =
    Set(
      ...
      (s"${moduleId}.depGraph", s"${moduleId}.dependencies"),
      (s"${moduleId}.depTree", s"${moduleId}.depGraph"),
      (s"${moduleId}.depList", s"${moduleId}.depGraph"),
      (s"${moduleId}.depWhy", s"${moduleId}.depGraph"),
      (s"${moduleId}.depStats", s"${moduleId}.depGraph"),
      (s"${moduleId}.depDot", s"${moduleId}.depGraph"),
      (s"${moduleId}.depMermaid", s"${moduleId}.depGraph"),
      (s"${moduleId}.depHtml", s"${moduleId}.depGraph"),
      ...
      (s"${moduleId}.repl", s"${moduleId}.runClasspath"),
      (s"${moduleId}.repl", s"${moduleId}.scalaVersion"),
      (s"${moduleId}.repl", s"${moduleId}.jvmOptions"),
      (s"${moduleId}.repl", s"${moduleId}.javaHome"),
      (s"${moduleId}.repl", s"${moduleId}.replJars"),
      (s"${moduleId}.replDeps", s"${moduleId}.scalaVersion"),
      (s"${moduleId}.replJars", s"${moduleId}.replDeps"),
