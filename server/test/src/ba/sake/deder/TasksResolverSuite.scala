...
class TasksResolverSuite extends munit.FunSuite {
  ...
  private def baseScalaModuleTaskEdges(moduleId: String): Set[(String, String)] =
    Set(
      ...
      (s"${moduleId}.compilerJars", s"${moduleId}.compilerDeps"),
      ...
      (s"${moduleId}.compileBsp", s"${moduleId}.sourceFiles"),
      (s"${moduleId}.compileBsp", s"${moduleId}.generatedSources"),
      (s"${moduleId}.compileBsp", s"${moduleId}.javaHome"),
      (s"${moduleId}.compileBsp", s"${moduleId}.javaVersion"),
      (s"${moduleId}.compileBsp", s"${moduleId}.javacOptions"),
      (s"${moduleId}.compileBsp", s"${moduleId}.scalacOptions"),
      (s"${moduleId}.compileBsp", s"${moduleId}.scalaVersion"),
      (s"${moduleId}.compileBsp", s"${moduleId}.compilerJars"),
      (s"${moduleId}.compileBsp", s"${moduleId}.compileClasspath"),
      (s"${moduleId}.compileBsp", s"${moduleId}.semanticdb"),
      (s"${moduleId}.compileBsp", s"${moduleId}.scalacPlugins"),
      (s"${moduleId}.compileBsp", s"${moduleId}.javacAnnotationProcessors"),
      (s"${moduleId}.compileBsp", s"${moduleId}.javaSemanticdbVersion"),
      (s"${moduleId}.compileBsp", s"${moduleId}.scalaSemanticdbVersion"),
      ...
      (s"${moduleId}.fix", s"${moduleId}.compileBsp"),
      ...
      (s"${moduleId}.fixCheck", s"${moduleId}.compileBsp"),
  ...
  private def transitiveScalaModuleTaskEdges(moduleId: String, dependencyModuleId: String): Set[(String, String)] =
    Set(
      ...
      (s"${moduleId}.compileBsp", s"${dependencyModuleId}.compileBsp"),
