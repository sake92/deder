...
class PublishIntegrationSuite extends BaseIntegrationSuite {
  ...
  override def beforeAll(): Unit = {
    projectPath = stagedServerProject(os.RelPath("sample-projects/publish"))
  ...
  // --- shared-server tests (6 tests, no mutations to the fixture) ---
  ...
  // --- isolated test: uses a different fixture ---
